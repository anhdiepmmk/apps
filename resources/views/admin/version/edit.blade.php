...
@section('content')
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li class="active">Version: {{ $version->name }}</li>
        </ul>
    </div>
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-cog fa-fw"></i> Version: {{ $version->name }}</h3>
        </div>
        <div class="panel-body">
            <form class="form-horizontal"  id="create_form"
            method="post" enctype="multipart/form-data"
            action="{{ URL::to('admin/app/'.$app->id.'/version/edit') }}"
            autocomplete="off">
            ...
            <input type="hidden" name="version_id" value="{{ $version->id }}" />
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly="readonly" value="{{ $app->com }}" class="form-control" placeholder="Version">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group date" id="bs-datepicker-component">
                            <input type="text" class="form-control" name="version_updated" value="{{ $version->version_updated->format('Y-m-d') }}"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
                </div> <!-- / .form-group -->
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                            <input type="text" class="form-control" name="minos" value="{{ old('minos',$version->minos) }}">
                    </div>
                </div> <!-- / .form-group -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="summernote-example" name="what_new">{{ old('name',$version->what_new) }}</textarea>
                    </div>
                </div> <!-- / .form-group -->
            </form>
