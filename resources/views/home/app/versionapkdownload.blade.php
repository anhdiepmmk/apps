                    ...
                    <div class="col-xs-12 col-sm-8">
                        ...
                        <p>
							...
							<p>Apps.com.mm provide the mirror server to <strong>download {{$app->name}} apk</strong>:</p>
	                            ...
	                            @if($version)
	                                <a class="nounderline" href="javascript:;" onclick="getapk()" >Download from Apps.com.mm and Install It
	                                    @if($version->appfiles->filesize)
	                                        ({{ human_filesize($version->appfiles->filesize) }})
	                                    @endif
	                                </a><br>
                                        <a class="nounderline" target="_blank" href="https://play.google.com/store/apps/details?id={{$app->com}}" title="Download {{ $app->name }} @if($version) {{$version->name}} @endif from Playstore" rel="nofollow"> Or Get it on Google Play</a>
	                            @endif
