...
@section('content')
    ...
    <div class="page-header" id="page-title">
	    <h1>Cron Download File</h1>
    </div> <!-- / .page-header -->

    <div>
        <ul class="breadcrumb">
            <li><a href="{{ url('admin') }}">Home</a></li>
            <li class="active">Cron Download File</li>
        </ul>
    </div>
        ...
        <div class="panel-body">
            <form class="form-horizontal"
                ...
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">Tổng Apps (Version) chưa lấy</label>
                    <div class="col-sm-9" id="total_left">

                    </div>
                </div> <!-- / .form-group -->
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">Version vừa lấy về</label>
                ...
                <div class="col-md-10 col-md-offset-3">
                    <button type="button" id="clickauto" class="btn btn-primary">Download APK</button>
                </div>
    ...
    <script type="text/javascript">
           ...
           function postSession(){
               var url = "{{ url('admin/downloadsession') }}";
               $.ajax({
                   type: 'POST',
                   url: url,
                   data: {
