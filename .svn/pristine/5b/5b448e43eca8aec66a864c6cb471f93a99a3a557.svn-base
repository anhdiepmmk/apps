...
(adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <div class="row panel-body">
                    ...
                    @endif
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <a  class="nounderline" target="_blank" href="{{ url('android-apps-games/'.$category->slug.'/'.$app->slug.'/'.$version->slug.'-download') }}" title="Download {{ $app->name}} @if($version) {{$version->name}} @endif"><i class="fa fa-cloud-download"></i> Proceed to {{ $app->name}} {{$version->name}} Download Page</a>
<div class="col-xs-12 col-sm-12">
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- linkadsauto -->
<ins class="adsbygoogle"
