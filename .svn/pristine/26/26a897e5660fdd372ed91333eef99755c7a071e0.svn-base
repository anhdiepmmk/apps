        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="nborder">
                ...
                <div class="row detailApp">
                    ...
                    <div>
                        You are downloading free <strong>{{$app->name}} {{ $version->name }}</strong> which is shareing by Apps.com.mm. Please select one of below server for downloading the Apk. It is so easy for installing your favour app.<br><br>
						This app is one of  {{ $category->name }} {{ $parentCategory->name }} which require your Mobile or Tablet using Android {{ $version->minos }}+. You also can find more information and click to the link below to <strong>download {{$app->name}} {{ $version->name }} apk</strong>. <br>
                            ...
                            <div class="col-xs-12 col-sm-9">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        ...
                                        <a  class="nounderline" target="_blank" href="{{ url('android-apps-games/'.$category->slug.'/'.$app->slug.'/'.$version->slug.'-download') }}" title="Download {{ $app->name}} @if($version) {{$version->name}} @endif"><i class="fa fa-cloud-download"></i> Direct Download APK from Apps.com.mm</a>
                                    </li>
                                    <li>
